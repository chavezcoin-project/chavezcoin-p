...
unsigned int nProtocolV03SwitchTime     = 1505792691; // Tuesday, September 19, 2017 3:44:51 AM
unsigned int nProtocolV03TestSwitchTime = 1496491392; // Saturday, June 3, 2017 12:03:12 PM
...
bool CheckStakeKernelHash(unsigned int nBits, const CBlock& blockFrom, unsigned int nTxPrevOffset, const CTransaction& txPrev, const COutPoint& prevout, unsigned int nTimeTx, uint256& hashProofOfStake, bool fPrintProofOfStake)
{
    ...
    // arepacoin: v0.3 protocol kernel hash weight starts from 0 at the 30-day min age
    // this change increases active coins participating the hash and helps
    // to secure the network when proof-of-stake difficulty is low
    // arepacoin: v0.1 protocol default kernel hash weight starts from 0 at the 3-day min age
