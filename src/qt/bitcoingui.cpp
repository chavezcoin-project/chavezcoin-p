 ...
 * The Arepacoin Developers 2011-2013
 * The Arepacoin Developers 2013-2014
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Arepacoin Portfolio"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/arepacoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send shares to a Arepacoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/arepacoin"), tr("&About %1").arg(qApp->applicationName()), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/arepacoin"), tr("Show/Hide &Arepacoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Arepacoin window"));
    ...
    exportArepacoinKeysAction = new QAction(QIcon(":/icons/export"), tr("&Export Arepacoin keys"), this);
    exportArepacoinKeysAction->setToolTip(tr("Export the Arepacoin keys associated with the Arepacoin addresses to Arepacoin via RPC"));
    ...
    connect(exportArepacoinKeysAction, SIGNAL(triggered()), this, SLOT(exportArepacoinKeys()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    shares->addAction(exportArepacoinKeysAction);
...
#ifndef Q_WS_MAC
            setWindowIcon(QIcon(":icons/arepacoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/arepacoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    notificator = new Notificator(tr("Arepacoin-qt"), trayIcon);
}
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide Arepacoin"
...
void BitcoinGUI::exportArepacoinKeys()
{
    try {
        int iExportedCount, iErrorCount;
        walletModel->ExportArepacoinKeys(iExportedCount, iErrorCount);
        QMessageBox::information(this,
                tr("Arepacoin keys export"),
                tr("%1 key(s) were exported to Arepacoin.\n%2 key(s) were either already known or invalid.")
                  .arg(iExportedCount)
                  .arg(iErrorCount)
                );
    }
