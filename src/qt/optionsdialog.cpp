        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start Arepacoin on system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start Arepacoin after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the Arepacoin client port on the router. This only works when your router supports UPnP and it is enabled."));
    layout->addWidget(map_port_upnp);

    connect_socks4 = new QCheckBox(tr("&Connect through SOCKS4 proxy:"));
    connect_socks4->setToolTip(tr("Connect to the Arepacoin network through a SOCKS4 proxy (e.g. when connecting through Tor)"));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show Arepacoin addresses in the transaction list"));
