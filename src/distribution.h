...
public:
    Distribution(CBitcoinAddress addrArepacoin, int64 nBalance, double dDividendAmount)
        : addrArepacoin(addrArepacoin), nBalance(nBalance), addrArepacoin(addrArepacoin), dDividendAmount(dDividendAmount)
    {
    }
