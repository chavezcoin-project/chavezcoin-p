...
static const int COINBASE_MATURITY_ARC = 100; // Adapted for Arepacoin - same as it is set in Bitcoin, where Arepacoin is 500
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
static const int STAKE_TARGET_SPACING = 60 * 30; // arepacoin: 30 minute block spacing 
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 3; // arepacoin: Minimum age for coin age changed to 3 days 
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // arepacoin: Stake age of full weight
static const int64 IPO_SHARES = 1000000 * COIN; // arepacoin: Total number of shares to create using proof of work (intented for IPO)
static const int64 PROOF_OF_WORK_BLOCKS = 400; // arepacoin: Block height of the last proof of work block
...
public:
    ...
    {
        // arepacoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of arepacoin spent by this transaction.
    ...
    /** Amount of arepacoin coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // arepacoin: get transaction coin age
...
public:
    ...
    // arepacoin: block signature - signed by coin base txout[0]'s owner
    ...
    // arepacoin: entropy bit for stake modifier if chosen by modifier
    ...
    // arepacoin: two types of block: proof-of-work or proof-of-stake
    ...
    // arepacoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // arepacoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // arepacoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // arepacoin: block index flags
    enum  
    {
