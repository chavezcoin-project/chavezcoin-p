...
// Copyright (c) 2012 The Arepacoin developers
...
extern std::map<std::string, std::string> mapArepacoinArgs;
extern bool fDebug;
...
const boost::filesystem::path &GetArepacoinDataDir(bool fNetSpecific = true);
boost::filesystem::path GetConfigFile();
boost::filesystem::path GetArepacoinConfigFile();
boost::filesystem::path GetPidFile();
void CreatePidFile(const boost::filesystem::path &path, pid_t pid);
void ReadConfigFile(std::map<std::string, std::string>& mapSettingsRet, std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet);
void ReadArepacoinConfigFile(std::map<std::string, std::string>& mapSettingsRet);
...
bool GetArepacoinBoolArg(const std::string& strArg, bool fDefault=false);
